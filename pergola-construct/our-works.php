...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css?_v=20231123143332"
        ...
        <div class="container">
            <div class="breadcrumbs">
                <nav class="breadcrumbs__nav">
                    <a class="breadcrumbs__first-item">Главная</a>
                ...
                <div class="big-work-examples_desk d-none d-md-block">
                    <div class="row mb-4">
                        <div class="col-4 d-flex flex-column justify-content-between">
                            <picture>
                                <source srcset="img/portfolio1.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio1.jpg" id="test-img"
                                     alt="Перголы Decolife Bioclimatic В600, B400; г. Москва, Фудмолл Депо, р-н Сыроварня [465]">
                            </picture>
                            <picture>
                                <source srcset="img/portfolio2.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio2.jpg" id="idimg"></picture>
                        </div>
                        <div class="col-5 d-flex flex-column justify-content-between">
                            <picture>
                                <source srcset="img/portfolio3.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio3.jpg" id="img"></picture>
                            <picture>
                                <source srcset="img/portfolio4.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio4.jpg" id="test"></picture>
                        </div>
                        <div class="col-3">
                            <picture>
                                <source srcset="img/portfolio5.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio5.jpg"></picture>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties13.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties13.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties11.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties11.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties12.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties12.jpg"></picture>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties14.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties14.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties10.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties10.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/portfolio2.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio2.jpg"></picture>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-4 d-flex flex-column justify-content-between">
                            <picture>
                                <source srcset="img/portfolio1.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio1.jpg"></picture>
                            <picture>
                                <source srcset="img/portfolio2.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio2.jpg"></picture>
                        </div>
                        <div class="col-5 d-flex flex-column justify-content-between">
                            ...
                            <picture>
                                <source srcset="img/portfolio3.webp" type="image/webp">
                                <img src="img/portfolio3.jpg" class="big-work-examples__img"></picture>
                            <picture>
                                <source srcset="img/portfolio4.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/portfolio4.jpg"></picture>
                        </div>
                        <div class="col-3">
                            <picture>
                                <source srcset="img/portfolio5.webp" type="image/webp">
                    ...
                    <div class="row">
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties7.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties7.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties8.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties8.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/varieties9.webp" type="image/webp">
                                <img class="big-work-examples__img" src="img/varieties9.jpg"></picture>
                        </div>
                        <div class="col">
                            <picture>
                                <source srcset="img/portfolio5.webp" type="image/webp">
            ...
            <div class="connection">
                <div class="connection__img">
                    <picture>
                        ...
                        <img src="img/man.png" alt="man" class="connection__img-elem"></picture>
                </div>
                ...
                <div class="connection__content">
                    <div class="connection__descr">
                        Оставьте свой номер телефона, мы перезвоним вам в течении пяти минут и рассчитаем стоимость
                        перголы
                    </div>
    ...
    <div class="modal__dialog">
        <div class="modal__content">
            <form action="form.php" method="post">
                ...
                <button class="stg-btn stg-btn_big modal__btn">Оставить Заявку</button>
            </form>
        </div>
    </div>
</div>
...
<script src="https://code.jquery.com/jquery-3.7.1.slim.min.js?_v=20231123143332"
