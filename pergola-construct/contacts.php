...
<html lang="en">
    ...
    <div class="row align-items-center gy-4 gy-xl-0">
        <div class="col-7 col-sm-5 col-md-4 col-lg-3">
            <h2 class="stg-h2 block-contacts__title">наши <span class="stg-text-accent block-contacts__accept-title">контакты</span></h2>
        </div>
        <div class="col-12 col-md-7 col-xl-4">
            <p class="block-contacts__phone">Заказы и клиентская поддержка: 8 800 600 61 93</p>
            <p class="block-contacts__phone-management">Связь с руководителем: +7 903 790 44 58</p>
            <p class="block-contacts__mail">E-mail: <a class="stg-text-accent block-contacts__mail-link">info@decolife.pro</a></p>
        </div>
        <div class="col-12 col-sm-4 col-md-3 col-xl-2">
            <p class="block-contacts__text-for-btn">Напишите нам через:</p>
        </div>
        <div class="col-12 col-sm-auto">
            <button class="stg-btn block-contacts__btn">
                <!--<img src="img/whatsapp-icon.svg">-->
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_78_761)">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9965 0L12.0035 0.000198364C18.6189 0.000198364 24 5.38285 24 12.0001C24 18.6172 18.6189 24 12.0035 24C9.56321 24 7.2993 23.2735 5.40222 22.0178L0.789795 23.4919L2.28502 19.0335C0.846336 17.058 0 14.6242 0 11.9999C0 5.38264 5.38113 0 11.9965 0ZM8.64642 6.09541C8.41374 5.53814 8.23739 5.51704 7.88489 5.5027C7.76486 5.49573 7.63111 5.48877 7.48282 5.48877C7.02422 5.48877 6.54473 5.62276 6.25552 5.91902C5.90302 6.27879 5.02843 7.11819 5.02843 8.8396C5.02843 10.561 6.28379 12.2259 6.45297 12.4588C6.62932 12.6914 8.90041 16.2752 12.4267 17.7357C15.1842 18.8786 16.0025 18.7727 16.63 18.6387C17.5468 18.4412 18.6965 17.7636 18.9857 16.9455C19.2749 16.127 19.2749 15.4286 19.1901 15.2805C19.1055 15.1323 18.8726 15.0479 18.5201 14.8713C18.1676 14.6949 16.4537 13.8483 16.1292 13.7354C15.8118 13.6156 15.5086 13.658 15.269 13.9967C14.9304 14.4693 14.599 14.9492 14.3309 15.2383C14.1193 15.464 13.7736 15.4923 13.4846 15.3722C13.0966 15.2102 12.0106 14.8289 10.6705 13.6367C9.63367 12.7127 8.92846 11.5629 8.72404 11.2172C8.51943 10.8646 8.70295 10.6598 8.86497 10.4694C9.04133 10.2506 9.21052 10.0955 9.38687 9.89084C9.56322 9.68636 9.66194 9.58044 9.7748 9.34053C9.89482 9.10778 9.81003 8.86787 9.72543 8.69147C9.64084 8.51507 8.93563 6.79365 8.64642 6.09541Z" fill="black"/>
                    </g>
                    <defs>
                        <clipPath id="clip0_78_761">
    ...
    <div class="row mb-5">
        <div class="col-8 col-sm-6 col-lg-3">
            <h2 class="stg-h2 office-addresses__title">офисы в <span class="stg-text-accent office-addresses__accept-title">регионах</span></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-1 d-none d-sm-block"></div>
        <div class="col-12 col-sm-5">
            <div class="office-addresses__block-list">
                <ul class="office-addresses__list">
                    <li class="office-addresses__item">
                        <p class="office-addresses__city"><span class="stg-text-accent">Москва</span>, шоу-рум: </p>
                        <p class="office-addresses__address">ЦД Artplay, ул. Нижняя Сыромятническая, 10</p>
                        <p class="office-addresses__phone">Тел. +7 963 600 70 10</p>
                    </li>
                    <li class="office-addresses__item">
                        <p class="office-addresses__city"><span class="stg-text-accent">Москва</span>, шоу-рум: </p>
                        <p class="office-addresses__address">ЦД Artplay, ул. Нижняя Сыромятническая, 10</p>
        ...
        <div class="col-6 d-none d-sm-block">
            <ul class="office-addresses__list">
                <li class="office-addresses__item">
                    <p class="office-addresses__city"><span class="stg-text-accent">Санкт-Петербург</span>, шоу-рум: </p>
                    <p class="office-addresses__address">ТЦ "Русская деревня", ул. Народного Ополчения 22, секция 210, 2 этаж</p>
                    <p class="office-addresses__phone">Тел. +7 905 280 00 50</p>
                </li>
                <li class="office-addresses__item">
                    <p class="office-addresses__city"><span class="stg-text-accent">Санкт-Петербург</span>, шоу-рум: </p>
                    <p class="office-addresses__address">ТЦ "Русская деревня", ул. Народного Ополчения 22, секция 210, 2 этаж</p>
            ...
            <section class="stg-section stg-section_margin stg-section_margin-small">
                <div class="container">
                    <div class="connection-form-small">
    <form>
        <div class="row align-items-center gy-4 gy-sm-0">
            <div class="col-12 col-lg-3">
                <h2 class="stg-h2 connection-form-small__title">свяжитесь <span class="stg-text-accent connection-form-small__accept-title">с нами</span></h2>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
                <textarea class="connection-form-small__textarea" placeholder="Что вас интересует?"></textarea>
            </div>
            <div class="col-12 col-sm-5">
                <div class="row mb-4 mb-xl-5 gy-4 gy-xl-0">
                    <div class="col-12 col-xl-6">
                        <input class="connection-form-small__input" placeholder="Имя" type="text">
                    </div>
                    <div class="col-12 col-xl-6">
                        <input class="connection-form-small__input" placeholder="Телефон" type="text">
                    </div>
                </div>
                <div class="row gy-4 gy-xl-0">
                    <div class="col-12 col-xl-6">
                        <input type="checkbox" class="connection-form-small__checkbox" id="connection-form-small__checkbox">
                        <label for="connection-form-small__checkbox">Даю согласие на обработку данных</label>
                    </div>
                    <div class="col-12 col-xl-6">
                        <button class="stg-btn connection-form-small__btn">Узнать больше</button>
                    </div>
                </div>
            </div>
        </div>
