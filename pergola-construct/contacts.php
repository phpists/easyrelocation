            ...
            <div class="block-contacts">
                <div class="row align-items-center gy-4 gy-xl-0">
                    <div class="col-7 col-sm-5 col-md-4 col-lg-3">
                        <h2 class="stg-h2 block-contacts__title">наши <span
                                    class="stg-text-accent block-contacts__accept-title">контакты</span></h2>
                    </div>
                    <div class="col-12 col-md-7 col-xl-4">
                        ...
                        <p class="block-contacts__mail">E-mail: <a class="stg-text-accent block-contacts__mail-link">info@decolife.pro</a>
                        </p>
                    </div>
            ...
            <div class="office-addresses">
                <div class="row mb-5">
                    <div class="col-8 col-sm-6 col-lg-3">
                        <h2 class="stg-h2 office-addresses__title">офисы в <span
                                    class="stg-text-accent office-addresses__accept-title">регионах</span></h2>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="office-addresses__block-list">
                            <ul class="office-addresses__list">
                                <li class="office-addresses__item">
                                    <p class="office-addresses__city"><span class="stg-text-accent">Москва</span>,
                                        шоу-рум: </p>
                    ...
                    <div class="col-6 d-none d-sm-block">
                        <ul class="office-addresses__list">
                            <li class="office-addresses__item">
                                <p class="office-addresses__city"><span class="stg-text-accent">Санкт-Петербург</span>,
                                    шоу-рум: </p>
                                <p class="office-addresses__address">ТЦ "Русская деревня", ул. Народного Ополчения 22,
                                    секция 210, 2 этаж</p>
                ...
                <form action="form.php" method="post">
                    <div class="row align-items-center gy-4 gy-sm-0">
                        <div class="col-12 col-lg-3">
                            <h2 class="stg-h2 connection-form-small__title">свяжитесь <span
                                        class="stg-text-accent connection-form-small__accept-title">с нами</span></h2>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <textarea class="connection-form-small__textarea"
                        ...
                        <div class="col-12 col-sm-5">
                            ...
                            <div class="row gy-4 gy-xl-0">
                                <div class="col-12 col-xl-6">
                                    <input type="checkbox" class="connection-form-small__checkbox"
                                           id="connection-form-small__checkbox">
                                    <label for="connection-form-small__checkbox">Даю согласие на обработку
                                        данных</label>
                                </div>
                                <div class="col-12 col-xl-6">
                                    <button type="submit" class="stg-btn connection-form-small__btn">Узнать больше</button>
                                </div>
                            </div>
                        </div>
                    </div>
