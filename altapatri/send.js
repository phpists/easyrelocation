...
if (!document.cookie.includes("utm_source")) {
  ...
  if (curReferer.length > 0 && !curReferer.indexOf("GetVisa") != -1) {
    switch (true) {
  ...
  forms.forEach(function (form) {
    ...
    if (window.location.href.indexOf("/grazhdanstvo-armenii") > -1) {
      form.insertAdjacentHTML(
        ...
        '<input name="' +
          "request_type" +
          '" class="utm" id="request_type" type="hidden" value="' +
          "Армения" +
          '">'
      );
    }
        ...
        if (json.error) {
          ...
          for (const property in errors) {
            let label = form
              ...
              .closest("label");
            label.querySelector("span.validation-field").textContent =
              errors[property];
          }
        } else {
          document
            .querySelector(".overflow-bg")
            .classList.add("show-modal-success");
          document
            .querySelector(".modal-success-review")
            .classList.add("show-modal-success");
          document.querySelector(".modal-success-review").style.display =
            "block";
          document
            ...
            .addEventListener("click", function () {
              document
                .querySelector(".overflow-bg")
                .classList.remove("show-modal-success");
              document
                .querySelector(".modal-success-review")
                .classList.remove("show-modal-success");
            });
