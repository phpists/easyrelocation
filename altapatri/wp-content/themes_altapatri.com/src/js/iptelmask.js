!function (b) {
    ...
    a.prototype = {
        defaults: {
            ...
            return g({
                ...
                value: a,
                metadata: b
            }, this.maskset || f(this.opts, this.noMasksCache), this.opts)
        }
        ...
        for (var d, j, i, k, g, l, m, y = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g, v = !1, c = new f, a = [], p = []; d = y.exec(w);) if (j = d[0], v) o(); else switch (j.charAt(0)) {
            ...
            case e.quantifiermarker.start:
                var r = new f(!1, !1, !0), h = (j = j.replace(/[{}]/g, "")).split(","),
                ...
                1: {
                    validator: function (a, e, b, f, c) {
                        ...
                        validator: function (c, b, a, g, d) {
                            ...
                            if (!g && !f) {
                                if (f = d.regex.val1.test(c + "0")) return b.buffer[a] = c, b.buffer[++a] = "0", {
                                    pos: a,
                                    c: "0"
                                };
    ...
    function c(a, b) {
        var e = (a.mask || a).replace(/#/g, "9").replace(/\)/, "9").replace(/[+()#-]/g, ""),
            f = (b.mask || b).replace(/#/g, "9").replace(/\)/, "9").replace(/[+()#-]/g, ""),
            c = (a.mask || a).split("#")[0], d = (b.mask || b).split("#")[0];
